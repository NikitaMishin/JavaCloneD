        ...
        show: function (n, e, t) {
            ...
            void 0 === u && (u = r), r.$menu = m('<ul class="context-menu-list"></ul>').addClass(r.className || "").data({
                ...
                if (o.type && v[o.type]) v[o.type].call(e, o, r, u), m.each([r, u], function (e, t) {
                    ...
                    o.type && "sub" !== o.type && "html" !== o.type && "cm_seperator" !== o.type && (a.on("focus", b.focusInput).on("blur", b.blurInput), o.events && a.on(o.events, r)), o.icon && (m.isFunction(o.icon) ? o._icon = o.icon.call(this, this, e, n, o) : "string" == typeof o.icon && "fa-" === o.icon.substring(0, 3) ? o._icon = u.classNames.icon + " " + u.classNames.icon + "--fa fa " + o.icon : o._icon = u.classNames.icon + " " + u.classNames.icon + "-" + o.icon, e.addClass(o._icon))
                }
            ...
            var c = this;
            void 0 === i && (i = s, $.resize(s.$menu));
            var l = !1;
            return s.$menu.children().each(function () {
                var e, t = m(this), n = t.data("contextMenuKey"), o = s.items[n],
                    a = m.isFunction(o.disabled) && o.disabled.call(c, n, i) || !0 === o.disabled;
    ...
    m.fn.contextMenu = function (e) {
        ...
        switch (n.context && n.context.length ? (a = m(n.context).first(), n.context = a.get(0), s = !m(n.context).is(document)) : n.context = document, e) {
            ...
            case"destroy":
                ...
                }), h = {}, x = {}, f = 0, d = !1, m("#context-menu-layer, .context-menu-list").remove();
                break;
            case"html5":
